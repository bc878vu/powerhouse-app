...
import DailyDieselReport from "./pages/DailyDieselReport";

const TABS = [
  ["dashboard", "Dashboard", LayoutDashboard],
  ["entry", "Fuel Entry", Fuel],
    ...
    <div className="min-w-0 space-y-4 pb-8">
      <div className="sticky top-0 z-30 rounded-2xl border border-white/10 bg-[#020617]/95 p-2 shadow-2xl backdrop-blur-xl">
        <div className="flex min-w-0 gap-2 overflow-x-auto">
          ...
          <div className="ml-auto hidden items-center gap-2 px-3 text-[9px] font-black uppercase tracking-[.18em] text-emerald-400 md:flex">
      ...
      {tab === "entry" && <FuelManagementLegacy initialView="entry" embedded />}
