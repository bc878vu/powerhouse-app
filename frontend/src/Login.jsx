...
import { ArrowRight, Lock, Mail, ShieldCheck, Chrome } from "lucide-react";
import { loginWithFirebase, loginWithGoogle } from "./firebaseAuth";
...
const friendlyAuthError = error => {
  ...
  const messages = {
    ...
    "permission-denied": "Firebase authentication succeeded, but Firestore permissions need to be deployed."
  };
...
export default function Login() {
  ...
  const submit = async event => {
    ...
    setError("");
    try {
      completeLogin(await loginWithFirebase(email, password));
    } catch (authError) {
  ...
  const googleLogin = async () => {
    ...
    setError("");
    try {
      completeLogin(await loginWithGoogle());
    } catch (authError) {
