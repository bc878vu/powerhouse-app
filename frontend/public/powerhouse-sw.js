...
// notificationclick is registered before Firebase Messaging so task routing stays ours.
...
const CACHE_VERSION = "powerhouse-static-v16";
...
function showPowerHouseNotification(payload) {
  ...
  return self.registration.showNotification(title, {
    ...
    timestamp: Date.now(),
    data: { route, notificationId, taskId },
  });
}
